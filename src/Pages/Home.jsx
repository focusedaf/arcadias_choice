      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="bg-black/50 backdrop-blur-sm p-8 rounded-lg text-white">
          <p className="text-lg leading-relaxed">
            In a world teetering on the edge of environmental crisis, you stand at the crossroads of change. 
            As Arcadia's chosen one, your knowledge and decisions will shape the fate of our planet's diverse realms. 
            Each realm faces unique challenges, and only through wisdom and understanding can we hope to preserve them.
          </p>
        </div>
